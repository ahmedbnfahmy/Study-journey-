...
Personal notes and summaries from courses, books, and videos — organized by topic for quick review.
...
| **JavaScript** | [JS-Concepts.md](./JS-Concepts/JS-Concepts.md) | Event loop, closures, primitives, type coercion |
| **Other** | [Other-Topics.md](./Other/Other-Topics.md) | Docker, Git, AWS, RabbitMQ |

## Structure

```
Study-journey/
├── Backend/           # APIs, auth, HTTP concepts
├── DataBase/          # SQL, NoSQL, indexing, storage
├── Data-Structures/   # DS fundamentals + problems
├── Engineering/       # SOLID, design patterns
├── FrontEnd/          # React, Angular
├── JS-Concepts/       # Core JavaScript
├── Other/             # DevOps, tools, platforms
└── Books/             # PDFs and book summaries
```

## Books

Reference material lives in [`Books/`](./Books/) — includes summaries (e.g. [DDIA](./Books/Book%20summery/DDIA.md)) and PDFs on algorithms, databases, and Node.js patterns.
