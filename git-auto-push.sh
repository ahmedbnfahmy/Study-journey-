...
Default behavior:
  - Pushes your current branch to its configured upstream (e.g. origin/main).
  - Refuses to run if you have uncommitted changes (working tree dirty).

Options:
  --auto-commit            Stage + commit uncommitted changes before pushing.
